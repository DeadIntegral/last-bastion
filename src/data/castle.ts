...
export const castleTechDefinitions: Record<CastleTechId, CastleTechDefinition> = {
  war_coffers: { id: 'war_coffers', branch: 'economy', name: '전쟁 금고', description: '전투 시작 지휘력 +25', icon: '✦', maxLevel: 5, baseCost: 100, requiredTier: 1 },
  logistics: { id: 'logistics', branch: 'economy', name: '보급로', description: '초당 지휘력 회복 +2.5', icon: '↟', maxLevel: 5, baseCost: 150, requiredTier: 1, prerequisite: { id: 'war_coffers', level: 1 } },
  command_vault: { id: 'command_vault', branch: 'economy', name: '지휘 저장고', description: '최대 지휘력 +40', icon: '◇', maxLevel: 5, baseCost: 200, requiredTier: 1, prerequisite: { id: 'logistics', level: 1 } },
  drill_yard: { id: 'drill_yard', branch: 'economy', name: '상비군 훈련소', description: '병사 소환 대기시간 -5%', icon: '⚑', maxLevel: 5, baseCost: 250, requiredTier: 2, prerequisite: { id: 'command_vault', level: 2 } },
  supply_standardization: { id: 'supply_standardization', branch: 'economy', name: '군수 표준화', description: '병사 소환 지휘 비용 -3%', icon: '▦', maxLevel: 5, baseCost: 300, requiredTier: 2, prerequisite: { id: 'command_vault', level: 3 } },
  spoils_accounting: { id: 'spoils_accounting', branch: 'economy', name: '전리품 회계', description: '전투 골드 획득량 +5%', icon: '●', maxLevel: 5, baseCost: 350, requiredTier: 2, prerequisite: { id: 'supply_standardization', level: 2 } },
  field_manuals: { id: 'field_manuals', branch: 'economy', name: '왕립 야전 교범', description: '전투 숙련 경험치 획득량 +5%', icon: '▤', maxLevel: 5, baseCost: 400, requiredTier: 2, prerequisite: { id: 'spoils_accounting', level: 2 } },
  war_tithe: { id: 'war_tithe', branch: 'economy', name: '승전 공납제', description: '적 처치 지휘력 +2', icon: '♢', maxLevel: 5, baseCost: 400, requiredTier: 3, prerequisite: { id: 'drill_yard', level: 3 } },
  ...
  mending_stone: { id: 'mending_stone', branch: 'defense', name: '재생 석재', description: '성채 체력 초당 회복 +1.5', icon: '✚', maxLevel: 5, baseCost: 400, requiredTier: 3, prerequisite: { id: 'battlements', level: 3 } },
  ...
  siege_calculus: { id: 'siege_calculus', branch: 'artillery', name: '공성 계산학', description: '적 성채 직접 포격 피해 +60', icon: '⌖', maxLevel: 5, baseCost: 450, requiredTier: 3, prerequisite: { id: 'giantbreaker_shells', level: 3 } },
};
...
export function castleBattleStats(levels: Record<CastleTechId, number>): CastleBattleStats {
  return {
    ...
    commandPerKill: 6 + levels.war_tithe * 2,
    ...
    castleRegenPerSecond: levels.mending_stone * 1.5,

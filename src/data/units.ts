...
export const troopDefinitions: Record<UnitId, TroopDefinition> = {
  ...
  guardian: {
    ...
    color: 0x476985, accent: 0xaed0e8, size: 21, tags: ['ground', 'armored'], icon: '◆', squadSize: 2, attackPattern: { kind: 'single' }, equipmentCostBase: 75, equipmentGrowth: { attack: 2, hp: 35, defense: 2, moveSpeed: 1.5 }, recruitCost: 0, grade: unitGradeById.guardian,
  },
  archer: {
  ...
  bulwark: {
    ...
    color: 0x804e59, accent: 0xe4a4a4, size: 22, tags: ['ground', 'armored'], icon: '◆', squadSize: 1, attackPattern: { kind: 'cleave', secondaryDamageMultiplier: 0.7 }, equipmentCostBase: 100, equipmentGrowth: { attack: 3, hp: 38, defense: 2.2, moveSpeed: 1.2 }, recruitCost: 350, requiredFortressTier: 2, grade: unitGradeById.bulwark,
  },
  cavalry: {
  ...
  ogreMage: makeTroop('ogreMage', { name: '오우거 마도사', cost: 185, maxHp: 900, defense: 4, attackDamage: 100, attackRange: 170, attackIntervalMs: 1_500, moveSpeed: 25, spawnCooldownMs: 5_200, size: 27, tags: ['ground', 'large', 'ranged', 'magic'], attackPattern: { kind: 'pierce', maxTargets: 2, followThroughRange: 105, secondaryDamageMultiplier: 0.8 }, icon: '✹', color: 0x755b47, accent: 0xf6c796, maxActivePerSide: 3 }),
  ...
  earthSpirit: makeTroop('earthSpirit', { name: '대지 정령', cost: 165, maxHp: 1150, defense: 9, attackDamage: 60, attackRange: 40, attackIntervalMs: 1_350, moveSpeed: 24, size: 25, tags: ['ground', 'elemental', 'armored'], attackPattern: { kind: 'cleave', secondaryDamageMultiplier: 0.7 }, icon: '◆', color: 0x7d6846, accent: 0xe2c88f, maxActivePerSide: 3 }),
  ...
  demonGuard: makeTroop('demonGuard', { name: '악마 근위병', cost: 175, maxHp: 1300, defense: 10, attackDamage: 75, attackRange: 44, attackIntervalMs: 1_200, moveSpeed: 30, tags: ['ground', 'demon', 'armored'], attackPattern: { kind: 'cleave', secondaryDamageMultiplier: 0.75 }, icon: '◆', color: 0x663746, accent: 0xe99aaf }),
  demonMage: makeTroop('demonMage', { name: '심연 마도사', cost: 185, maxHp: 750, defense: 4, attackDamage: 95, attackRange: 210, attackIntervalMs: 1_450, moveSpeed: 33, tags: ['ground', 'ranged', 'demon', 'magic'], attackPattern: { kind: 'pierce', maxTargets: 3, followThroughRange: 135, secondaryDamageMultiplier: 0.65 }, icon: '☿', color: 0x563366, accent: 0xdba8ef }),
  ...
  ifrit: makeTroop('ifrit', { name: '이프리트', cost: 200, maxHp: 2200, defense: 8, attackDamage: 140, attackRange: 215, attackIntervalMs: 1_650, moveSpeed: 42, spawnCooldownMs: 6_600, size: 29, tags: ['flying', 'large', 'demon', 'elemental', 'ranged', 'magic'], attackPattern: { kind: 'pierce', maxTargets: 3, followThroughRange: 150, secondaryDamageMultiplier: 0.75 }, icon: '✹', color: 0xc44831, accent: 0xffd06a, recruitCost: 0, recruitSource: 'challenge', maxActivePerSide: 2 }),
